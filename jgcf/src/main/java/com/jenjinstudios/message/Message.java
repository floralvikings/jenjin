...
public class Message
{
	 ...
	 * MessageInputStream.  You should <b>not</b> use this constructor in your code.  If, for some reason, you decide
	 * to (and you really, really shouldn't) the arguments you pass <b>must</b> fill every available argument and
	 * be passed in the order in which they appear in the XML file.
	 *
	 ...
	 *                     will be thrown.
	 * @param argument     The value to set to the argument.  If the type of this object is incorrect, an
