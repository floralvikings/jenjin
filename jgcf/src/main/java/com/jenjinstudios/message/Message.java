...
public class Message
{
	 ...
	 *  You should <b>not</b> use this constructor in your code.  If, for some reason, you decide to (and you really,
	 * really shouldn't) the arguments you pass <b>must</b> fill every available argument and be passed in the order in
