 ...
 */
public class ExecutableWorldChecksumRequest extends WorldExecutableMessage<ServerMessageContext>
{
	/**
	 ...
	 */
	public ExecutableWorldChecksumRequest(WorldClientHandler handler, Message message, ServerMessageContext context) {
